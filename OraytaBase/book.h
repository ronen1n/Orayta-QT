...
public:
    ...
    QList <SearchResult> findInBook(const QRegularExpression& regexp);
    ...
    QUrl renderChapterHtml(BookIter iter, BookList * bl, bool shownikud, bool showteamim, QRegularExpression mark = QRegularExpression());
...
protected:
    ...
    QString resultPreview(const QRegularExpression& exp, int offset);
