...
QString ExternalLink (QString linkcode)
{
    ...
    QTextCodec * codec = QTextCodec::codecForName("ISO-8859-8");
...
QUrl Book::renderChapterHtml(BookIter iter, BookList * booklist, bool shownikud, bool showteamim, QRegularExpression mark)
{
    static int ind = 0;
